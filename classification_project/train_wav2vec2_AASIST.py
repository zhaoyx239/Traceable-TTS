...
from models.wav2vec2_AASIST import AASISTWithWav2Vec  # 替换为你实现的模型
import numpy as np
...
def main():
    ...
    # 初始化模型
    model = AASISTWithWav2Vec(input_channels=1, num_classes=1, wav2vec_model_name="/hpc_stor03/sjtu_home/yuxiang.zhao/classification_project/models/wav2vec2-base")
