...
def main():
    ...
    # 加载模型权重
    model = load_model_with_module(model, '/hpc_stor03/sjtu_home/yuxiang.zhao/classification_project/best_model_lfcc_lcnn.pth', device)
    model.to(device)

    # 测试数据路径
    real_train_data = "/hpc_stor03/sjtu_home/yuxiang.zhao/data/infer/cosyvoice/train-clean-100"
    real_val_data = "/hpc_stor03/sjtu_home/yuxiang.zhao/data/infer/cosyvoice/dev-clean"
    real_test_data = "/hpc_stor03/sjtu_home/yuxiang.zhao/data/infer/cosyvoice/test-clean"
