...
output_base_dir = "/hpc_stor03/sjtu_home/yuxiang.zhao/data/MM/f5tts/origin_bigvgan/test-clean"

# 静态参数
model = "F5-TTS"  # F5-TTS | E2-TTS

# GPU 配置
gpus = [0,1,2,3,4,5,6,7]  # 使用的GPU编号
gpu_count = len(gpus)
